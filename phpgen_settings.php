...
function GetGlobalConnectionOptions()
{
    return
        array(
          'server' => 'fbw-database-1.ctxgjpmtl0xs.us-east-2.rds.amazonaws.com',
          'port' => '3306',
          'username' => 'admin',
          'password' => 'Gar1nfr0styB33r',
          'database' => 'fbw-Knack',
...
{
    $result = array();
    $result[] = array('caption' => 'Batches', 'short_caption' => 'Batches', 'filename' => 'Batches.php', 'name' => 'Batches', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Brews', 'short_caption' => 'Brews', 'filename' => 'Brews.php', 'name' => 'Brews', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Templates', 'short_caption' => 'Templates', 'filename' => 'Templates.php', 'name' => 'Templates', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
